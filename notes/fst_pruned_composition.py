...
bpe_medium = [
    (26361, 'zon'), (14032, ' purple'), (33439, ' MIDI'), (43499, 'announced'),
    (33034, ' hardened'), (18411, ' thermal'), (42034, 'devices'), (42415, ' ankles'),
    (44356, ' Turtles'), (14886, ' Tyler'), (42111, ' infiltrate'), (46641, ' vividly'),
    (22999, ' burnt'), (5973, 'icken'), (817, 'Th'), (32498, ' clones'), (42535, '}}}'),
    (20933, ' warehouse'), (31641, ' Rw'), (3200, ' secret'), (15114, ' clouds'), (24081, ' Pav'),
    (40220, '1973'), (45577, ' Lauderdale'), (22846, 'ANN'), (9409, 'isd'), (12374, 'ettings'),
    (18180, ' rivers'), (25353, ' Background'), (14977, ' arbitrary'), (15545, ' Install'),
    (48465, ' microbiome'), (35094, ' Gau'), (40935, ' Daesh'), (17410, 'Method'),
    (41589, 'Harris'), (8975, ' Sometimes'), (29173, '644'), (12187, ' cake'),
    (34909, ' disabling'), (4849, ' Sal'), (22507, ' Allow'), (34480, ' Colony'),
    (2439, ' Sm'), (709, 'ov'), (47261, 'wat'), (16069, ' ranges'), (13431, ' frames'),
    (39911, ' Lov'), (35905, ' infuri'), (32630, ' ivory'), (24709, ' Speech'), (11258, 'arer'),
    (33994, '>('), (2135, 'ift'), (30433, 'utsche'), (22318, '375'), (24536, ' metro'),
    (45772, ' Byzantine'), (15688, 'sky'), (37748, ' layered'), (20047, ' emphasized'),
    (33738, ' righteousness'), (5459, 'ocket'), (23699, ' Carbon'), (43382, ' Vapor'),
    (1360, 'gy'), (21732, ' trophies'), (47915, '561'), (29532, 'facing'),
    (50004, ' Collections'), (4568, ' activities'), (7943, ' Arizona'), (6749, 'ician'),
    (13003, 'Added'), (23898, ' recons'), (33516, ' Tek'), (25367, 'brow'),
    (33725, ' Saiyan'), (6828, 'ounter'), (28496, 'aughty'), (4818, ' dat'),
    (35954, ' Deadline'), (7171, ' Series'), (3529, 'ero'), (35051, 'reflect'),
    (49377, ' topple'), (13834, ' proc'), (19526, '�'), (5369, ' identity'), (10936, ' Gary'),
    (38232, ' onward'), (20231, 'Address'), (14594, ' Working'), (14063, ' Yam'),
    (38632, ' ejected'), (13941, ' avoided'), (15929, ' Neil'), (21981, ' angels'),
    (5055, ' standing'), (45439, ' 406'), (46811, ' Townsend'), (29225, ']."'), (16635, 'Bo'),
    (4826, 'Ab'), (15518, ' Cand'), (67, 'd'), (23236, ' purported'), (37238, ' skirm'),
    (31175, '>:'), (46280, 'swe'), (27180, 'lake'), (27464, ' scaled'), (19831, 'itsu'),
    (34917, ' Freeze'), (42131, 'edited'), (35047, ' Cooperation'), (16813, 'iberal'),
    (30996, ' peacefully'), (16288, 'heimer'), (15598, ' sentiment'), (26151, ' ingest'),
    (13927, 'wear'), (28729, ' OVER'), (30256, ' loser'), (29836, ' asshole'), (15496, 'Hello'),
    (3667, ' claims'), (42303, ',...'), (43455, ' stressing'), (14610, ' -->'),
    (13504, ' exploring'), (43144, ' dipping'), (37156, ' Chero'), (9974, ' Drive'),
    (4109, ' Rober'), (35234, 'wives'), (1084, 'min'), (16537, ' lately'), (41843, ' valves'),
    (6967, ' collabor'), (46556, '088'), (35702, 'ック'), (15613, ' constitute'), (9154, ' tape'),
    (21994, ' astonishing'), (4070, 'azing'), (24269, ' Trent'), (42375, ' Angle'),
    (21546, ' therapeutic'), (8822, 'eland'), (23833, 'alks'), (10857, ' Temple'), (37689, 'holiday'),
    (39763, ' ~/.'), (20129, ' java'), (11440, ' Ident'), (4392, ' Syria'), (47598, 'Crash'),
    (47223, 'owsky'), (22681, ' ballistic'), (22025, ' Sto'), (16386, ' Experience'),
    (30898, 'embedreportprint'), (30699, ' hardship'), (41632, ' believable'), (22201, ' incarn'),
    (17208, 'arse'), (9272, ' gathered'), (46618, ' 413'), (34324, ' indifference'),
    (20821, ' snapped'), (22226, ' paradox'), (19303, ' interim'), (10287, ' les'),
    (17468, ' Bennett'), (3264, ' directly'), (4369, ' disease'), (4885, ' Western'), (14804, '=>'),
    (40323, ' Kut'), (39081, 'administ'), (33749, ' derail'), (15797, ' trim'), (10889, ' Sure'),
    (18330, ' inspire'), (45928, 'flying'), (3134, '67'), (41512, ' Err'), (7967, ' Snow'),
    (30543, '"\''), (33244, 'Success'), (40145, ' JPM'), (11185, ' meets'), (32571, ' Rohing'),
    (2132, 'ully'), (6462, ' Full'), (29519, 'ه'), (31975, 'warm'), (28740, ' calorie')
]
...
bpe_small = [
    ...
    (44356, ' Turtles'), (14886, ' Tyler'), (42111, ' infiltrate'), (46641, ' vividly'),
    (22999, ' burnt'), (5973, 'icken'), (817, 'Th'), (32498, ' clones'), (42535, '}}}'),
    (20933, ' warehouse'), (31641, ' Rw'), (3200, ' secret')
]
...
class CoarseCompositionFilter:
    ...
    def fidelity(a2b, b2c, keep, filter_time):
        ...
        before = time()
        fine = a2b._pruned_compose(b2c, keep=lambda x: True, keep_arc=lambda i,label,j: True)
        fine.trim
        took = time() - before
        ...
        print(colors.yellow % 'filter overhead:', colors.green % (filter_time/took) if filter_time < took else colors.light.red % (filter_time/took), filter_time, took)


        print(1 - (len(F) - len(T)) / (len(fine.states) - len(T)) if (len(fine.states) - len(T)) > 0 else 1)
...
def test_bpe():
    ...
    with benchmark['unpruned']:
        full = b2c @ c2c
    print(colors.yellow % 'states:', len(full.states), len(full.trim.states),
          colors.yellow % 'arcs:', len(list(full.arcs())), len(list(full.trim.arcs())))
...
#                N2 = random_hash(buckets),
    ...
    print(colors.yellow % 'states', len(have.trim.states), '<=', len(have.states),
          colors.yellow % 'arcs', len(list(have.trim.arcs())), '<=', len(list(have.arcs())))
...
def test_basic1():
    ...
    before = time()
    keep = CoarseCompositionFilter(a2b, b2c, N1=lambda x: '#', A=lambda x: '$', B=lambda x: '$', C=lambda x: '$', N2=lambda x: '#')
    filter_time = time() - before
    CoarseCompositionFilter.fidelity(a2b, b2c, keep, filter_time)
