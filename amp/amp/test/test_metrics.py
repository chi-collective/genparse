...
from ambiguous_parsing.metrics.fewshot_metrics import (
    FewshotDatasetMetric,
    FewshotInstanceMetric,
)
...
def test_fewshot_dataset_all_correct():
    pred_data = [
        {'top_k_preds': ['mocklf0 ( arg0 ) AND mocklf0 ( arg1 )']},
        {'top_k_preds': ['mocklf1 ( arg0 ) AND mocklf1 ( arg1 )']},
    ]
    gold_data = [
        {
            'natural': f'mock example {i}',
...
def test_fewshot_dataset_all_incorrect():
    pred_data = [
        {
            'top_k_preds': ['notmocklf0 ( arg0 ) AND notmocklf0 ( arg1 )'],
        }
        for _ in range(2)
    ]
    gold_data = [
...
def test_fewshot_instance_all_correct():
    data_by_src = {
        'mock example 0': [
            {'template_idx': '0', 'logit_at_label': [1.0, 1.0, 1.0]},
    ...
    gold_data_lut = {
        'mock example 0': {'0': {'type': 'mocktype'}, '1': {'type': 'mocktype'}},
        'mock example 1': {'0': {'type': 'mocktype'}, '1': {'type': 'mocktype'}},
    }
    ratio = 1.0
...
def test_fewshot_instance_half_correct():
    data_by_src = {
        ...
        'mock example 1': [
            {'template_idx': '0', 'logit_at_label': [0.0, 0.0, 0.0]},
...
def test_fewshot_instance_custom_MSE():
    data_by_src = {
        'mock example 0': [
            {'template_idx': '0', 'logit_at_label': [1.0, 0.5, 1.0]},
...
def test_zeroshot_dataset_all_correct_k1_either():
    pred_data = [
        {
            'top_k_preds': [
                'exists arg0 . exists arg1 . mocklf0(arg0) AND mocklf0(arg1)',
                'exists arg0 . exists arg1 . mocklf1(arg0) AND mocklf1(arg1)',
            ]
        },
        {
            'top_k_preds': [
                'exists arg0 . exists arg1 . mocklf0(arg0) AND mocklf0(arg1)',
                'exists arg0 . exists arg1 . mocklf1(arg1) AND mocklf1(arg0)',
            ]
        },
    ]
    gold_data = [
...
def test_zeroshot_dataset_all_correct_k2_either_positive():
    pred_data = [
        {
            'top_k_preds': [
                'exists arg0 . exists arg1 . notmocklf0(arg0) AND notmocklf0(arg1)',
                'exists arg0 . exists arg1 . mocklf1(arg0) AND mocklf1(arg1)',
            ]
        },
        {
    ...
    pred_data = [
        {
            'top_k_preds': [
                'exists arg0 . exists arg1 . notmocklf0(arg0) AND notmocklf0(arg1)',
                'exists arg0 . exists arg1 . notmocklf1(arg0) AND notmocklf1(arg1)',
            ]
        },
        {
            'top_k_preds': [
