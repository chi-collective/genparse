...
def load_results(results_name, raw_spider_dir=None):
    if os.path.exists(f'{results_name}-evaluated.jsonl'):
        with open(f'{results_name}-evaluated.jsonl', 'r') as f:
            return [json.loads(line) for line in f]
    else:
        with open(f'{results_name}.jsonl', 'r') as f:
            results = [json.loads(line) for line in f]

        assert raw_spider_dir is not None, 'provide raw_spider_dir to evaluate'
        ...
        with open(f'{results_name}-evaluated.jsonl', 'w') as f:
